...
#endif
#ifndef OCALL_PRINT_TIMED_STRING_DEFINED__
#define OCALL_PRINT_TIMED_STRING_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_print_timed_string, (const char* str));
#endif
#ifndef OCALL_WRITE_PLAIN_STRING_DEFINED__
#define OCALL_WRITE_PLAIN_STRING_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write_plain_string, (const char* str));
#endif
#ifndef OCALL_SAVE_SEALED_DATA_DEFINED__
#define OCALL_SAVE_SEALED_DATA_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_save_sealed_data, (uint8_t* sealed_blob, uint32_t sealed_data_size));
#endif
